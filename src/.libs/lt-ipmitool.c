...
/* ./.libs/lt-ipmitool.c - temporary wrapper executable for .libs/ipmitool
   Generated by libtool (GNU libtool) 2.6.2

   The ipmitool program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "ipmitool"; /* hopefully, no .exe */
...
main (int argc, char *argv[])
{
  ...
  lt_debugprintf (__FILE__, __LINE__, "libtool wrapper (GNU libtool) 2.6.2\n");
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# ipmitool - temporary wrapper script for .libs/ipmitool\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.6.2\n", f);
  fputs ("#\n", f);
  fputs ("# The ipmitool program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  generated_by_libtool_version='2.6.2'\n", f);
  ...
  fputs ("        lt_dump_D=`$ECHO \"X$lt_script_arg0\" | sed -e 's/^X//' -e 's%/[^/]*$%%'`\n", f);
  fputs ("        test \"X$lt_dump_D\" = \"X$lt_script_arg0\" && lt_dump_D=.\n", f);
  fputs ("        lt_dump_F=`$ECHO \"X$lt_script_arg0\" | sed -e 's/^X//' -e 's%^.*/%%'`\n", f);
  ...
  fputs ("    echo \"ipmitool:ipmitool:$LINENO: libtool wrapper (GNU libtool) 2.6.2\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"ipmitool:ipmitool:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"ipmitool:ipmitool:$LINENO: newargv[0]: $progdir/$program\" 1>&2\n", f);
  ...
  fputs ("    fi\n", f);
  fputs ("\n", f);
  fputs ("    file=`$ECHO \"$file\" | sed 's%^.*/%%'`\n", f);
  fputs ("    file=`ls -ld \"$thisdir/$file\" | sed -n 's/.*-> //p'`\n", f);
  fputs ("  done\n", f);
  fputs ("\n", f);
  ...
  fputs ("    *[\\\\/].libs ) thisdir=`$ECHO \"$thisdir\" | sed 's%[\\\\/][^\\\\/]*$%%'` ;;\n", f);
  fputs ("    .libs )   thisdir=. ;;\n", f);
  fputs ("    esac\n", f);
  fputs ("  fi\n", f);
  fputs ("\n", f);
