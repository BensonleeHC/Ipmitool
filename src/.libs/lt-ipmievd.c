...
/* ./.libs/lt-ipmievd.c - temporary wrapper executable for .libs/ipmievd
   Generated by libtool (GNU libtool) 2.6.2

   The ipmievd program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "ipmievd"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# ipmievd - temporary wrapper script for .libs/ipmievd\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.6.2\n", f);
  fputs ("#\n", f);
  fputs ("# The ipmievd program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"ipmievd:ipmievd:$LINENO: libtool wrapper (GNU libtool) 2.6.2\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"ipmievd:ipmievd:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"ipmievd:ipmievd:$LINENO: newargv[0]: $progdir/$program\" 1>&2\n", f);
